...
const FamilyLifeMonthTwi = () => {
    ...
    useEffect(() =>{
      ...
      const query = `*[_type == "brochure" && title == "Your Family Life Can Be Happy" && language == "Twi"  && date >= "${startOfMonth}" && date <= "${endOfMonth}"]{quantity}`;
...
export default FamilyLifeMonthTwi