...
const BibleTeachMonthTwi = () => {
    ...
    useEffect(() =>{
      ...
      const query = `*[_type == "book" && title == "Bible Teach/Teach Us" && language == "Twi"  && date >= "${startOfMonth}" && date <= "${endOfMonth}"]{quantity}`;
...
export default BibleTeachMonthTwi