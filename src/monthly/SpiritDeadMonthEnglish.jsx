...
const SpiritDeadMonthEnglish = () => {
    ...
    useEffect(() =>{
      ...
      const query = `*[_type == "brochure" && title == "Spirits of the Dead" && language == "English" && date >= "${startOfMonth}" && date <= "${endOfMonth}"]{quantity}`;
...
export default SpiritDeadMonthEnglish