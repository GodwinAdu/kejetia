...
const BibleTeachMonthEnglish = () => {
    ...
    useEffect(() =>{
      ...
      const query = `*[_type == "book" && title == "Bible Teach/Teach Us" && language == "English"  && date >= "${startOfMonth}" && date <= "${endOfMonth}"]{quantity}`;
...
export default BibleTeachMonthEnglish