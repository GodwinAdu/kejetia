...
const GoodNewsMonthEnglish = () => {
    ...
    useEffect(() =>{
      ...
      const query = `*[_type == "brochure" && title == "Good News" && language == "English"  && date >= "${startOfMonth}" && date <= "${endOfMonth}"]{quantity}`;
...
export default GoodNewsMonthEnglish