...
const YoungPeopleTwoTwi = () => {
    ...
    useEffect(() =>{
        ...
        const query = `*[_type == "book" && title == "Young People Ask Vol 2" && language == "Twi" && date >= "${startOfYear}" && date <= "${endOfYear}"]{quantity}`;
...
export default YoungPeopleTwoTwi