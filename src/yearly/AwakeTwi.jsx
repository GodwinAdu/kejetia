...
const AwakeTwi = () => {
    const [awakeTwi, setAwakeTwi] = useState(0)
    ...
    useEffect(() =>{
        ...
        const query = `*[_type == "magazine" && title == "Awake" && language == "Twi" && date >= "${startOfYear}" && date <= "${endOfYear}"]{quantity}`;
