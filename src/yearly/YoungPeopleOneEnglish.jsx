...
const YoungPeopleOneEnglish = () => {
    ...
    useEffect(() =>{
         ...
         const query = `*[_type == "book" && title == "Young People Ask Vol 1" && language == "English" && date >= "${startOfYear}" && date <= "${endOfYear}"]{quantity}`;
...
export default YoungPeopleOneEnglish