...
const SecretHappinessTwi = () => {
    ...
    useEffect(() =>{
        ...
        const query = `*[_type == "book" && title == "Secret of family happiness" && language == "Twi"  && date >= "${startOfYear}" && date <= "${endOfYear}"]{quantity}`;
...
export default SecretHappinessTwi