...
const WatchtowerEnglish = () => {
    ...
    useEffect(() =>{
         ...
         const query = `*[_type == "magazine" && title == "Watch Tower" && language == "English" && date >= "${startOfYear}" && date <= "${endOfYear}"]{quantity}`;
...
export default WatchtowerEnglish